 ...
 *
 */
public class XVariationHeuristicDeterministicFirstBest implements HeuristicInterface {
	
	List<Client> warehouses;
	private static Logger logger = Logger.getLogger(PropertiesService.class);
	EntryData entryData;

	public XVariationHeuristicDeterministicFirstBest() {
	...
	public List<Delivery> buildHeuristic(EntryData data){
		...
		try {
			deliveryList = createDeliveryList(data);
			data = entryData;
		} catch (Exception e) {
...
/**------------------------- RANDOMISATION DE DEPART -----------------------------**/
	 ...
	 * @throws Exception 
	 */
	private List<Delivery> createDeliveryList(EntryData data) throws Exception {
